 ...
 * @since 3.3
 */
public class CustomGaussianCurveFitter extends AbstractCurveFitter {
     ...
     */
    private CustomGaussianCurveFitter(double[] initialGuess, int maxIter, LeastSquaresOptimizer optimizer) 
    {
     ...
     */
    public static CustomGaussianCurveFitter create() 
    {
        return new CustomGaussianCurveFitter(null, Integer.MAX_VALUE, new LevenbergMarquardtOptimizer());
    }
     ...
     */
    public CustomGaussianCurveFitter withStartPoint(double[] newStart) 
    {
        return new CustomGaussianCurveFitter(newStart.clone(), maxIter, optimizer);
    }
     ...
     * @return a new instance.
     */
    public CustomGaussianCurveFitter withMaxIterations(int newMaxIter) {
        return new CustomGaussianCurveFitter(initialGuess, newMaxIter, optimizer);
    }
    
    public CustomGaussianCurveFitter withOptimizer(LeastSquaresOptimizer newOptimizer)
    {
    	return new CustomGaussianCurveFitter(initialGuess, maxIter, newOptimizer);
    }
