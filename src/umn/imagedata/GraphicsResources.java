...
import umn.gl.builders.ColorTextureBuilder;
...
import umn.gl.types.AbstractDataTypeFactory;
import umn.gl.util.BoundedVertexGeometry;
import umn.gl.util.VertexGeometry;
import umn.gl.util.VertexGeometryImpl;
import umn.gl.vecmath.IntVector3;
import umn.gl.vecmath.Matrix4;
import umn.gl.vecmath.Vector3;

public final class GraphicsResources<ContextType extends Context<ContextType>> implements AutoCloseable
{
    ...
    public static final class Builder<ContextType extends Context<ContextType>>
    {
        ...
        public GraphicsResources<ContextType> create() throws IOException
        {
            ...
            return new GraphicsResources<>(context, viewSet, geometry, loadOptions, loadingMonitor);
        }
    }
    ...
    private GraphicsResources(ContextType context, ViewSet viewSet, VertexGeometry geometry, ReadonlyLoadOptionsModel loadOptions, LoadingMonitor loadingMonitor) throws IOException
    {
        this.context = context;
        ...
        {
            @SuppressWarnings("UseOfObsoleteDateTimeApi") Date timestamp = new Date();
    ...
    public static File findImageFile(File requestedFile) throws FileNotFoundException
    {
        ...
        else
        {
            ...
            for(String extension : altFormats)
            {
                ...
                System.out.printf("Trying '%s'", imageFileGuess.getAbsolutePath());
                System.out.println();
