...
/**
 * An interface for an object that can serve as a shader, one of several components of a program.
 ...
 */
public interface Shader<ContextType extends Context<ContextType>> extends ManagedResource, ContextBound<ContextType>
{
