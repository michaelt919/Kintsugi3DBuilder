...
public class SimpleAnimationController implements GraphicsRequestController
{
    ...
    {
        String fxmlFileName = "fxml/modals/export/SimpleAnimationUI.fxml";
        URL url = SimpleAnimationController.class.getClassLoader().getResource(fxmlFileName);
        assert url != null : "Can't find " + fxmlFileName;

        FXMLLoader fxmlLoader = new FXMLLoader(url);
        Parent parent = fxmlLoader.load();
        SimpleAnimationController simpleAnimationUI = fxmlLoader.getController();
