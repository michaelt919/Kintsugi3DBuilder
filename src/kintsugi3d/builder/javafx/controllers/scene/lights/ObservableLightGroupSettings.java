...
import kintsugi3d.builder.state.project.SerializableLightGroupSettings;

import java.util.ArrayList;

public class ObservableLightGroupSettings extends SerializableLightGroupSettings<ObservableLightSettings>
{
    public static final int LIGHT_LIMIT = 4;

    private final ListProperty<ObservableLightSettings> lightList = new SimpleListProperty<>(new ObservableListWrapper<>(new ArrayList<>(LIGHT_LIMIT)));
    ...
    public ObservableLightGroupSettings()
    {
    }

    public ObservableLightGroupSettings(String name)
    {
        this.setName(name);
    }

    @Override
    public ObservableLightSettings constructLightInstanceSetting()
    {
        return new ObservableLightSettings(locked);
    }
    ...
    public void addLight()
    {
        ...
        {
            lightList.add(new ObservableLightSettings(locked));
        }
    }
    ...
    public void addLight(int index, double targetX, double targetY, double targetZ)
    {
        if (lightList.size() < LIGHT_LIMIT)
        {
            ...
            {
                ObservableLightSettings newLight = lightList.get(index).duplicate();
    ...
    @Override
    public ObservableList<ObservableLightSettings> getLightList()
    {
        return lightList.get();
    }

    public ListProperty<ObservableLightSettings> lightListProperty()
    {
        return lightList;
    }
