...
import kintsugi3d.builder.io.gltf.usdz.USDZExporter;
...
public class ExportSettings
{
    ...
    private MaterialExporterFactory exporterFactory = USDZExporterFactory.getInstance();
    ...
    public void applyToExporter(ModelExporter exporter, TextureResources<?> textureResources, String filename)
    {
        ...
        else if (materialExporter instanceof USDZExporter)
        {
            ((USDZExporter) materialExporter).setGlbName(filename);
        }
