...
{
    private final IndexAssignableMaterialBasis materialBasis;

    public SimpleBasisResources(ContextType context, IndexAssignableMaterialBasis materialBasis)
    {
    ...
    @Override
    public IndexAssignableMaterialBasis getBasis()
    {
