...
public enum StandardTexture
{
    ...
    OCCLUSION(new TextureDetails("occlusion", "Occlusion map",
        "An imported occlusion map that represents how much ambient light can reach the surface based on neighboring geometry: cracks and crevices receive less ambient light than smooth surfaces.  Occlusion maps are never generated by Kintsugi 3D Builder, so the only way for this to be present is via import.")),
