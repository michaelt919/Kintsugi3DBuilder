package tetzlaff.ibrelight.rendering.components.focal;
...
import tetzlaff.ibrelight.rendering.components.scene.FocalGrid;
import tetzlaff.ibrelight.rendering.components.snap.ViewSnapContent;
import tetzlaff.ibrelight.rendering.resources.IBRResources;

import java.io.FileNotFoundException;

public class FocalCalibrationContent <ContextType extends Context<ContextType>> extends ViewSnapContent<ContextType>
{
    ...
    private FocalGrid<ContextType> focalgrid;

    public FocalCalibrationContent(IBRResources<ContextType> resources, SceneModel sceneModel,
    ...
    public void initialize() throws FileNotFoundException
    {
        ...
        focalgrid = new FocalGrid<>(resources, sceneModel, sceneViewportModel);
        focalgrid.initialize();
    }

    @Override
    public void reloadShaders() throws FileNotFoundException
    {
        focalgrid.reloadShaders();
    }
    ...
    public void drawInSubdivisions(FramebufferObject<ContextType> framebuffer, int subdivWidth, int subdivHeight, CameraViewport cameraViewport)
    {
        ...
        focalgrid.getProgram().setUniform("holeFillColor", new Vector3(0.5f));
        ...
        try(UniformBuffer<ContextType> viewIndexBuffer = context.createUniformBuffer())
        {
            ...
            focalgrid.getProgram().setUniformBuffer("ViewIndices", viewIndexBuffer);

            // Draw the actual object, without model transformation for light calibration
            focalgrid.drawInSubdivisions(framebuffer, subdivWidth, subdivHeight,
