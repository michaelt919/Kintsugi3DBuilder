...
import tetzlaff.ibrelight.rendering.components.focal.FocalCalibrationContent;
import tetzlaff.ibrelight.rendering.components.snap.ViewSnap;
import tetzlaff.ibrelight.rendering.resources.IBRResources;

public class FocalCalibrationRoot <ContextType extends Context<ContextType>> implements RenderedComponent<ContextType>
{
    ...
    public FocalCalibrationRoot(IBRResources<ContextType> resources, SceneModel sceneModel,
    ...
    {
        viewSnapRoot.takeContentRoot(new FocalCalibrationContent<>(resources, sceneModel, sceneViewportModel));
