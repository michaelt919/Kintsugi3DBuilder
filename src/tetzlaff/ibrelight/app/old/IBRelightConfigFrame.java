...
import tetzlaff.ibrelight.app.old.util.BTFRequestUI;
import tetzlaff.ibrelight.app.old.util.FidelityMetricRequestUI;
...
//            chckbxUseTextures.setSelected(rendererListModel.getSelectedItem().getSettingsModel().areTexturesEnabled());
        ...
        {//TODO here is the loading
            ...
            if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION)
            {
                ...
                try
                {
                    IBRLoadOptionsModelImpl loadOptions = new IBRLoadOptionsModelImpl()
