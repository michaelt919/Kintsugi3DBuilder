...
public class FidelityMetricRequestOld implements IBRRequest
{
    ...
    public FidelityMetricRequestOld(File exportPath, File targetVSETFile, File maskFile, ReadonlySettingsModel settings)
    {
