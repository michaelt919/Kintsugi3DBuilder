...
public class IntegratingMatrixRequestUI implements IBRRequestUI
{
    ...
    public static IntegratingMatrixRequestUI create(Window window, IBRelightModels modelAccess) throws IOException
    {
        String fxmlFileName = "fxml/export/IntegratingMatrixRequestUI.fxml";
        URL url = IntegratingMatrixRequestUI.class.getClassLoader().getResource(fxmlFileName);
        assert url != null : "Can't find " + fxmlFileName;

        FXMLLoader fxmlLoader = new FXMLLoader(url);
        Parent parent = fxmlLoader.load();
        IntegratingMatrixRequestUI integratingMatrixRequestUI = fxmlLoader.getController();

        integratingMatrixRequestUI.stage = new Stage();
        integratingMatrixRequestUI.stage.getIcons().add(new Image(new File("ibr-icon.png").toURI().toURL().toString()));
        integratingMatrixRequestUI.stage.setTitle("Fidelity matrix request");
        integratingMatrixRequestUI.stage.setScene(new Scene(parent));
        integratingMatrixRequestUI.stage.initOwner(window);

        return integratingMatrixRequestUI;
    }
