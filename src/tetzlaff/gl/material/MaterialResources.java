...
public class MaterialResources<ContextType extends Context<ContextType>> implements Resource
{
    ...
    public static class MaterialLoadOptions
    {
    ...
    MaterialResources(ContextType context, Material material, File textureDirectory, MaterialLoadOptions loadOptions) throws IOException
    {
